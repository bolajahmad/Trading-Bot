...
const Content = () => {
    ...
    <Container as='section' id='content' fluid>
        <Container as='section' className='main-content' fluid>
            <div style={{position: 'relative', margin: '0.5em', padding: '0.5em'}}>
                <Link to='/dashboard'>
                    <p className='wallet'>
                        <FontAwesomeIcon icon={faDollarSign} color='white' /> Go To Wallet
                    </p>
                </Link>
                <h3>Dashboard</h3>
            </div>
