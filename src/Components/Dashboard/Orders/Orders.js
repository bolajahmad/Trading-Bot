...
const caretStyleLeft = {
    cursor: 'pointer', 
    background: 'rgb(32, 72, 148)', 
    color: 'whitesmoke',
    padding:' 0.5em',
    paddingTop: '0.7em',
    marginLeft: '0.5em',
...
const floatedSign = {
    border: '0.1em solid rgb(32, 72, 148)',
    background: 'rgb(32, 72, 148)',
    float: 'right',
    width: 'auto',
    cursor: 'pointer',
           ...
           <Col sm={12}>
                <Card style={cardStyles}>
                    <Card.Title className='px-4 pt-3 pb-1'>
                        <span style={floatedSign} aria-controls='bookOpen' onClick={() => setBookOpen(!bookOpen)}>
                                    ...
                                    <Col md={6} sm={12}>
                                        <Table responsive striped hover className='mt-10'>
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <span style={caretStyleLeft}><FontAwesomeIcon icon={faCaretDown} size='2x' /></span>
                                                    </th>
                                                    <th>Sum</th>
                                                    <th>Total</th>
                                                    <th>Size</th>
                                        ...
                                        <Table responsive striped hover className='mt-10'>
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Sum</th>
                                                    <th>
                                                        <span style={caretStyleRight}><FontAwesomeIcon icon={faCaretDown} size='2x' /></span>
                                                    </th>
                                                </tr>
                                            </thead>
            ...
            <Col sm={12}>
                <Card style={cardStyles}>
                    <Card.Title className='px-4 pt-3 pb-1'>
                        <span style={floatedSign} aria-controls='openOrder' onClick={() => setOpenOrder(!openOrder)}>
                            <FontAwesomeIcon icon={faPlus} color='white' />
                        </span>
                        Open Orders
                    </Card.Title>
                    ...
                    <Collapse in={openOrder}>
                        <Card id='openOrder' style={{fontSize: '0.7rem'}}>
                                        ...
                                        <Form>
                                            <Form.Group>
                                                <Form.Row>
                                                    ...
                                                    <Col sm={6} className='pl-0 m-0'>
                                                        <Button style={{margin: '0'}} variant='outline-secondary'>Search</Button>
                                                    </Col>
                                                </Form.Row>
                                            </Form.Group>
                                        </Form>
                                    ...
                                    <Col sm={{span: '4', offset: '4'}}>
                                        <Form.Row>
                                            ...
                                            <Col sm={6} className='pl-0'>
                                                <Button style={{margin: '0'}} variant='outline-secondary'>
                                                    Apply
                                                </Button>
                                            </Col>
                                        </Form.Row>
            ...
            <Col sm={12}>
                <Card style={cardStyles}>
                    <Card.Title className='px-4 pt-3 pb-1'>
                        <span style={floatedSign} onClick={() => setOpenHistory(!openHistory)}>
                            <FontAwesomeIcon icon={faPlus} color='white' />
                        </span>
                        Market History
                    </Card.Title>
            ...
            <Col sm={12}>
                <Card style={cardStyles}>
                    <Card.Title className='px-4 pt-3 pb-1'>
                        <span style={floatedSign} onClick={() => setOpenOrderHistory(!openOrderHistory)}>
                            <FontAwesomeIcon icon={faPlus} color='white' />
                        </span>
                        My Order History
                    </Card.Title>
